...
export class AppComponent {
  ...
  title2 = [
    ["JUNE’19 CABLE TV NPS & OVERALL SATISFACTION​",
  ...
  data2 = [
    [
      [-56.8, -44.1, -51.2, -44.4, -45.9, -44.5, -35.1, -44.8, -39.9, -35.7, -29.5, -34.2],
  ...
  title3 = [
    ["JUNE’19 HUBTROOPERS TNPS BY COMPANY​",
  ...
  data3 = [
    [
      [31, 29.7, 32.9, 31.1, 32.1, 34.6, 29.4, 32.8, 33.9, 30.2, 34.4, 39.4],
  ...
  values3 = [
    ["Planet Smart services Pt. Ltd", "Earnest Corporation Pt. Ltd", "StarHub Ltd"],
